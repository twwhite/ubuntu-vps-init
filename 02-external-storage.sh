...
echo "//$HETZNER_ID.your-storagebox.de/backup$REMOTE_BASE_DIR $EXT_MOUNT_DIR cifs iocharset=utf8,rw,mfsymlinks,credentials=/etc/backup-credentials.txt,uid=$NON_ROOT_USER,gid=$NON_ROOT_USER,file_mode=0660,dir_mode=0770 0 0" | sudo tee -a /etc/fstab
